Usage Mate is there to calculate, give insights on the usage and costs for any device.
It's optmized to work with dynamic or switching energy prices based on time of day.

1. Create a Usage Mate device 
2. Choose the type of measuring you would like (kWh, W, m3, GJ, l, g, oz, gal, ft3)
3. In settings of the device you can optionally set the preffered currency
